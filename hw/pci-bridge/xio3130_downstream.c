...
static void xio3130_downstream_reset(DeviceState *qdev)
{
    ...
    pcie_acs_reset(d, p->acs_caps == ACS_CAP_UNDEFINED ? 0 : p->acs_caps);
...
static void xio3130_downstream_realize(PCIDevice *d, Error **errp)
{
    ...
    rc = pcie_acs_init(d, XIO3130_ACS_OFFSET,
                       p->acs_caps == ACS_CAP_UNDEFINED ? 0 : p->acs_caps, errp);
    if (rc < 0) {
        goto err;
    }
...
static const Property xio3130_downstream_props[] = {
    ...
    DEFINE_PROP_UINT16("acs-caps", PCIEPort, acs_caps, ACS_CAP_UNDEFINED),
};
